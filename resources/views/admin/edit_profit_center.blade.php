          ...
          <div class="box-body">
            ...
            <form action="{{ url('/finance/form-profit-center-update') }}" method="POST" >
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="profit_code" value="{{ $pfct_list->pfct_code }}" placeholder="Enter Profit Center Code" maxlength="2">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="profit_name" value="{{ $pfct_list->pfct_name }}" placeholder="Enter Profit Center Name">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                         ...
                         <input list="compList"  id="comp_code" name="comp_code" class="form-control  pull-left" value="{{ $pfct_list->company_code }}" placeholder="Select Company Code" >
              ...
              <div style="text-align: center;">
                ...
                <input type="hidden" name="pfctId" value="{{ $pfct_list->id }}">
