    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Add Profit Center </h2>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="profit_code" value="{{ old('profit_code')}}" placeholder="Enter Profit Center Code" maxlength="2">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="profit_name" value="{{ old('profit_name') }}" placeholder="Enter Profit Center Name">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                         ...
                         <input list="compList"  id="comp_code" name="comp_code" class="form-control  pull-left" value="{{ old('comp_code')}}" placeholder="Select Company Code" >
      ...
      <div class="col-sm-3">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="{{ url('/finance/view-mast-profit-center') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Profit Center</a>
