...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/form-mast-company') }}">Add Mast Company</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Add Master Company</h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('form-mast-company-save') }}" method="POST" >
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="contact_no1" value="{{ old('contact_no1')}}" placeholder="Enter Contact Number 1" maxlength="10">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="contact_no2" value="{{ old('contact_no2')}}" placeholder="Enter Contact Number 2" maxlength="10">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="fax_no" value="{{ old('fax_no')}}" placeholder="Enter Fax Number">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="email" class="form-control" name="emailid" value="{{ old('emailid')}}" placeholder="Enter Email Id">
              ...
              <div class="row">
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="address_one" class="form-control" placeholder="Address 1" value="{{ old('address_one')}}">
                      ...
                      <input type="text" name="address_two" class="form-control" style="margin-top: 2%" placeholder="Address 2" value="{{ old('address_two')}}">
                      ...
                      <input type="text" name="address_three" class="form-control" style="margin-top: 2%" placeholder="Address 3" value="{{ old('address_three')}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                       ...
                       <input name="city_code" class="form-control" value="{{ old('city_code')}}" placeholder="Enter City Code">
