...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/finance/form-mast-item-class') }}">Master Item Type</a></li>



            <li class="active"><a href="{{ url('/finance/form-mast-item-class') }}">Add Item Type</a></li>
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-sort-numeric-asc" aria-hidden="true"></i></span>
                           ...
                           <input type="text" class="form-control Number" name="item_type_code" value="{{ $item_type_code }}" placeholder="Enter Item Type Code">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="item_type_name" value="{{ $item_type_name }}" placeholder="Enter Item Class Name">
...
<?php } ?>
      ...
      <div class="col-sm-3">
        ...
        <div class="box-tools pull-right">
          ...
          <a href="{{ url('/finance/view-mast-item-type') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-eye"></i>&nbsp;&nbsp;View Item Type</a>
