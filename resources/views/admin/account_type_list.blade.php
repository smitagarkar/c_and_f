...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/edit-account-type/'.base64_encode($acctype_list->id)) }}">Master Acc Type</a></li>

            <li class="active"><a href="{{ url('/edit-account-type/'.base64_encode($acctype_list->id)) }}">Edit Mast Acc Type</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="acc_type_code" value="{{ $acctype_list->acctype_code }}" placeholder="Enter Account Type Code">
