...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="false" data-keyboard="false" data-backdrop="static">
  ...
  <div class="modal-dialog modal_diloge modal-lg" role="document" >
    ...
    <div class="modal-content modal-popout-bg" style="border-radius: 7px;">
      ...
      <form method="post" action="{{ url('access-control-update') }}">
      ...
      <div class="row" >
       ...
       <?php  $getdata=[]; ?>
        ...
        <?php foreach($user_type_id as $key) {

               $getdata[] = $key->form_name_id;
        ...
        <?php foreach ($form_name_list as $row) { 
            ...
            $explode = explode('_', $row->form_number);
             ...
             $retVal = (in_array($row->id, $getdata)) ? 'checked' : '' ;
         ...
         <input class="form-check-input filtercheck"  type="checkbox" value="<?php echo $row->id; ?>" <?php echo $retVal; ?> id="inward_trans" name="name1[]" >
 ...
 <?php }  ?>
        ...
        <div class="col-sm-5">
         ...
         <?php foreach ($form_name_list1 as $key) { 
           ...
           $number1 = $explode1[2];
             ...
             $retVal1 = (in_array($key->id, $getdata)) ? 'checked' : '' ;
          ...
          <div class="form-check box-text">
            ...
            <label class="form-check-label" for="defaultCheck1">
              ...
              {{ucwords($key->menu_name)}} - {{ucwords($key->form_name)}} <!-- - {{ $number1 }} -->
           ...
           <div class="col-sm-2 my-1">
            ...
            <input class="form-check-input filtercheck" type="checkbox" value="{{ $key->id }}" <?php echo $retVal1; ?> id="rate_form" name="name1[]">
       ...
       <?php  $getdata=[]; ?>
        ...
        <?php foreach ($form_name_list2 as $row) { 
 ...
 <?php }  ?>
        ...
        <div class="col-sm-5">
         ...
         <?php foreach ($form_name_list3 as $key) { 
      ...
      <div style="text-align: center;padding-bottom: 5%;padding-top: 5%">
        ...
        <button type="submit" onclick="return validation();" id="send_form" class="btn btn-primary" >Update</button>
