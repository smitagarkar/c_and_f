...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/rept-sap-list') }}">List Sap List Report</a></li>
  ...
  <section class="content">
     ...
     <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;"> Sap List Report</h2>
            ...
            <div class="box-body">
             ...
             <form id="myForm">
              ...
              <div class="row">
               ...
               <button type="button" class="btn btn-primary" name="btnsearch" id="btnsearch"><i class="fa fa-search" aria-hidden="true"></i> &nbsp;&nbsp;Search</button>
...
<table id="SapBillDispatch" class="table table-bordered table-striped table-hover">

  <thead class="theadC">

     <tr>

      <th colspan="5" class="text-center">SAP Bill</th>

      <th colspan="4" class="text-center">Physical Despatch</th>
    ...
    <tr>
      ...
      <th class="text-center">Inv AQty</th>
    ...
    load_data();
       ...
       $('#btnsearch').click(function(){
          ...
          if (dept_code!='' || acct_code!='' || from_date!='' || to_date!='' || trans_code!='') {
            ...
            $('#SapBillDispatch').DataTable().destroy();
