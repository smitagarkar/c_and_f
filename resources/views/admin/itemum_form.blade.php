...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/form-mast-itemum') }}">Add Mast Item Um</a></li>
      ...
      <div class="col-sm-8">
        ...
        <div class="box box-primary Custom-Box">
            ...
            <div class="box-header with-border" style="text-align: center;">
              ...
              <h2 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">Add Item Um </h2>
          ...
          <div class="box-body">
            ...
            <form action="{{ url('form-mast-itemum-save') }}" method="POST" >
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" name="item_code">
                            ...
                            <option value="{{ $key->item_code }}">{{ $key->item_code }} [{{$key->item_code}}]</option>
                      ...
                      <div class="input-group">
                          ...
                          <span class="input-group-addon"><i class="fa fa-arrow-right"></i></span>
                           ...
                           <select class="form-control" name="um_code">
                            ...
                            <option value="{{ $key->um_code }}">{{ $key->um_code }} [{{$key->um_name}}]</option>
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="aum" class="form-control" placeholder="Enter AUM" value="{{ old('aum')}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" name="aum_factor" class="form-control" placeholder="Enter AUM Factor" value="{{ old('aum_factor')}}">
