                  ...
                  <table id="example" class="table table-bordered table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr> 
                        ...
                        <td align="center">{{ $key->rack_block }}</td>

                        <td align="center"><a href="{{ url('/finance/edit-rack/'.base64_encode($key->id)) }}"><i class="fa fa-pencil btn btn-warning btn-xs" title="edit"></i></a> | <button type="button"  class="btn btn-danger btn-xs" data-toggle="modal" data-target="#fleetDelete_{{ $sr_no }}">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
          ...
          <form action="{{ url('/finance/delete-rack') }}" method="post">
            ...
            <input type="hidden" name="rackId" id="rackId" value="{{ $key->id }}">
