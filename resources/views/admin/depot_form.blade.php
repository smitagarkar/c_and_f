                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="depot_code" placeholder="Enter Depot Code" value="{{ old('depot_code')}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="depot_name" placeholder="Enter Depot Name" value="{{ old('depot_name')}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="contact_no" value="{{ old('contact_no')}}" placeholder="Enter Contact Number" maxlength="10">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="email" class="form-control" name="contact_email" value="{{ old('contact_email')}}" placeholder="Enter Contact Email">
