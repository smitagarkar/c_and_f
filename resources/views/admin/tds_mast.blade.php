                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="tds_code" value="{{$tds_code}}" placeholder="Enter TDS Code">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="surchargegl_code" value="{{$surchargegl_code}}" placeholder="Enter Surchargegl Code">
                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control Number" name="cessgl_code" value="{{$cessgl_code}}" placeholder="Enter Cessgl Code">
