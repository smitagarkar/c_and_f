                    ...
                    <div class="form-group">
                      ...
                      <label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="vehicle_mfg_code" value="{{old('vehicle_mfg_code')}}" placeholder="Enter Vehicle Mfg Code">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="vehicle_mfg_name" value="{{old('vehicle_mfg_name')}}" placeholder="Enter Vehicle Mfg Name">
