...
<small>View Details</small>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><a href="{{ url('/finance/view-tax') }}">Master Tax</a></li>

            <li class="active"><a href="{{ url('/finance/view-tax') }}">View Tax</a></li>
...
<h3 class="box-title animated bounceInLeft PageTitle" style="font-weight: 800;color: #5696bb;">View Tax</h3>

<div class="box-tools pull-right">

<a href="{{ url('/finance/tax') }}" class="btn btn-primary" style="margin-right: 10px;"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Tax</a>
