                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="depotList"  id="depot_code" name="depot_code" class="form-control  pull-left" value="{{ $sapbil_list->depot_code}}" placeholder="Select Depot" >
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="invoice_date" id="inv_date" class="form-control datepicker" value="{{ $sapbil_list->invoice_date }}" placeholder="Select Invoice Date">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="inv_no" name="invoice_no" placeholder="Enter Invoice No" value="{{ $sapbil_list->invoice_no }}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input list="accountList" id="account_code" name="account_code" class="form-control  pull-left" value="{{ $sapbil_list->acct_code }}" placeholder="Select Customer" >
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="areaList" id="area_code" name="area_code" class="form-control  pull-left" value="{{ $sapbil_list->area_code }}" placeholder="Select Area / Destination">
                  ...
                  <div class="form-group">
                      ...
                      <label for="exampleInputEmail1">Transaction Date : <span class="required-field"></span></label>
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="transaction_date" id="transaction_date" class="form-control transdatepicker" value="{{ $sapbil_list->vr_date }}" >
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="transList" id="transport_code" name="transport_code" class="form-control  pull-left" value="{{ $sapbil_list->trpt_code }}" placeholder="Select Transporter">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control vehiclenumup" id="vehicle_no" name="vehicle_no" placeholder="Enter Vehicle No" value="{{ $sapbil_list->truck_no }}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <!-- <input type="text" class="form-control" id="item_code" name="item_code" placeholder="Enter Item"> -->
                         ...
                         <input list="itemList" id="item_code" name="item_code" class="form-control  pull-left" value="{{ $sapbil_list->item_code }}" placeholder="Select Item">
