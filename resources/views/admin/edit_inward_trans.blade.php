                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" placeholder="Enter Vehicle No" value="{{ $inward_list->truck_no}}" minlength="0" maxlength="14">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <select class="form-control" id="flag" name="flag">
                            ...
                            <option value="D" <?php if($inward_list->flag == 'D'){ echo "SELECTED"; } ?>>D</option>
