                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="depotList"  id="Depot" name="depot_code" class="form-control  pull-left" value="{{ $inward_list->depot_code }}" placeholder="Select Depot Name" >
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="transaction_date" id="transaction_date" class="form-control transdatepicker" placeholder="Select Transaction Date" value="{{$inward_list->vr_date}}">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="transaction_no" name="transaction_no" placeholder="Enter Transaction Number" value="{{$inward_list->vr_no}}">
                ...
                <div class="col-md-4 setinmobileDiv">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input list="accountList" id="account_code" name="account_code" class="form-control  pull-left" value="{{ $inward_list->acc_code }}" placeholder="Select Account Code" >
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input type="text" class="form-control vehiclenumup" id="vehicle_no" name="vehicle_no" placeholder="Enter Vehicle No" value="{{ $inward_list->truck_no}}" minlength="0" maxlength="14">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input type="text" class="form-control" id="invoic_no" name="invoice_no" placeholder="Enter Invoice No" value="{{ $inward_list->invoice_no }}" minlength="0" maxlength="14">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="invoice_date" id="invoic_date" class="form-control datepicker" placeholder="Select Invoice Date" value="{{ $inward_list->invoice_date }}">
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input list="itemList" id="item_code" name="item_code" class="form-control  pull-left"placeholder="Select Item Code" value="{{ $inward_list->item_code }}">
  ...
  $(document).ready(function(){
      $('#sort_qty').on('change',function(){
          ...
          if(damgqty ==''){
            ...
            AdditionQty = parseFloat(sortQty)+parseFloat(damgqty);
            recvQunatity = $('#recd_qty').val();
            Addrecvrtn = parseFloat(recvQunatity)+parseFloat(AdditionQty);

            stoQunatityum = $('#sto_qtyum').val();

            if(Addrecvrtn == stoQunatityum){
              $("#showerrsort").html('');
              $("#showerrdmg").html('');
              $("#showerrrtn").html('');
              return true;
