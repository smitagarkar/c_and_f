                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <select id="despatch_type" name="despatch_type" class="form-control">
                              ...
                              <option value="S" <?php if($outward_trans_list->desp_type=='S') { echo "SELECTED"; } ?>>S</option>   
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="item" name="item" placeholder="Enter Item " value="{{ $outward_trans_list->item_code }}" readonly>
                ...
                <div class="col-md-4">
                  ...
                  <label for="exampleInputEmail1">Despatch Quantity : <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="despatch_qty" name="despatch_qty" placeholder="Enter SO Code" value="{{ $outward_trans_list->desp_qty }}" readonly>
                ...
                <div class="col-md-4">
                  ...
                  <label for="exampleInputEmail1">Despatch AQuantity : <span class="required-field"></span></label>
                      ...
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="despatch_aqty" name="despatch_aqty" placeholder="Enter SO Code" value="{{ $outward_trans_list->desp_aqty }}" readonly>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" name="vehicle_no" id="vehicle_no" placeholder="Enter Vehicle No" value="{{ $outward_trans_list->truck_no }}" readonly>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control" id="transport_code" name="transport_code" placeholder="Enter Inv qty aum" value="{{ $outward_trans_list->trans_code }}" readonly>
