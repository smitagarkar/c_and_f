                  ...
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <div class="input-group-addon">
                           ...
                           <input type="text" class="form-control vehiclenumup" id="vehicle_no" name="vehicle_no" placeholder="Enter Vehicle No" value="{{ old('vehicle_no')}}" minlength="0" maxlength="14" >
