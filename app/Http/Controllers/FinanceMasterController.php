...
/*	GLSCH master start */
	...
	public function DeleteConfig(Request $request){
    	...
    	if ($configId!='') {
    		...
    		$Delete = DB::table('master_config')->where('id', $configId)->delete();
	...
	/*gl key master*/
		...
		return view('admin.gl_key_mast',$userData+compact('button','action','glkeycode','glcode','acctypecode','amt_type','key_id'));
	...
	public function EditGlKey($id){
    	...
    	if($id!=''){
			...
			$acctypecode = $uData->acctype_code;
			...
			return view('admin.gl_key_mast',$userData+compact('title','glkeycode','glcode','acctypecode','amt_type','key_id','button','action'));
		}else{
			$request->session()->flash('alert-error', 'Config Not Found...!');
			return redirect('/finance/view-gl-key-mast');
		}
